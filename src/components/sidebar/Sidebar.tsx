...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navConfig = {
    ...
    teacher: [
      ...
      { id: 'assignments', label: 'AI Assignment Creator', icon: <Sparkles className="w-4 h-4 text-emerald-500" /> },
    ...
    hod: [
      ...
      { id: 'volunteers', label: 'Volunteer Sourcing', icon: <HeartHandshake className="w-4 h-4" /> },
    ],
    admin: [
    ...
    <>
      ...
      >
        <div className="space-y-6">
          ...
          {/* User Persona Pill */}
          <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200/80 dark:border-slate-700/60">
            <div className="flex items-center gap-2.5">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  <span className="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded bg-slate-200/70 dark:bg-slate-700/80 text-slate-600 dark:text-slate-300">
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-2">
          ...
          {role === 'student' && (
            <div className="p-3 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/30 border border-emerald-200 dark:border-emerald-800/60 space-y-2">
              <div className="flex items-center justify-between text-xs font-bold">
                <span className="text-emerald-800 dark:text-emerald-300">Live Stress Level</span>
                <span className="font-mono text-emerald-600 dark:text-emerald-400">
                  {studentStressResult.normalized_score}%
                </span>
              </div>
              <div className="w-full bg-emerald-200/60 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden">
                <div
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-md shadow-emerald-600/20 transition-all active:scale-95"
          >
